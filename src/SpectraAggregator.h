...
public:
	...
	int	initializeFromSpectraFilePath(const char* filePath, const Config* config, int generationIdx=0, int fileIdx=0, bool overwriteExisitngLocations=false);

	int	initializeFromListOfPaths(const vector<string>& paths, int generationIdx=0, 
