...
public:
	...
	DatFile() : indOpen_(0), fileIdx_(MAX_UINT), archiveFileIndex_(MIN_INT),
	...
	bool readSpectrum(const DatSpectrumStats& stats, SingleSpectrumHeader* header, Peak* peaks);
	...
	int    getAarchiveFileIndex() const { return archiveFileIndex_; }
