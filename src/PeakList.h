...
public:
	PeakList() : header_(0), config_(0), numPeaks_(0), peaks_(0), localAllocationSize_(0),
				totalPeakIntensity_(0), totalNormalizedPeakIntensity_(0) {};
	...
	void createIndexArray(vector<int>& indexArray, mass_t externalMaxMass=0.0) const;
	...
	void	outputToMgfStream(ostream& os, const SingleSpectrumHeader* newHeader = 0) const;
