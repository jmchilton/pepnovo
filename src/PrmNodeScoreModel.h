...
public:
	...
	PrmNodeScoreModel(): ind_was_initialized(false), indNormzlizersInitialized_(false), config_(NULL) {};
	...
	void learnPrmNormalizerValue(void* allScoreModelsVoidPointer, const SpectraAggregator& sa);
	...
	bool getIndNormalizersInitialized() const { return indNormzlizersInitialized_; }
private:

	bool ind_was_initialized;

	bool indNormzlizersInitialized_;
